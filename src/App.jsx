      ...
      <div className="flex flex-col min-h-screen bg-purple-950 text-white">
        ...
        <div className="flex-grow p-4">
          <div className="chat-display space-y-4">
            {chatHistory.map((chat, index) => (
              <div
                ...
                className={`p-3 rounded-lg ${
                  chat.type === "question"
                    ? "bg-pink-600 text-white self-end text-right w-fit max-w-[90%] ml-auto"
                    : "bg-purple-800 text-white self-start text-left w-fit max-w-[90%]"
                }`}
              >
                ...
                {chat.type === "answer" && (
                  <div className="flex flex-wrap justify-end mt-2 space-x-2">
                    <button
                      ...
                      className="flex items-center text-gray-300 mt-2 mr-2"
                    >
            ...
            {generatingAnswer && (
              <div className="p-3 rounded-lg bg-purple-900 animate-pulse">
                <div className="h-4 bg-purple-700 rounded w-3/4 mb-2"></div>
                <div className="h-4 bg-purple-700 rounded w-2/3 mb-2"></div>
        ...
        <form
          ...
          className="flex items-center w-full bg-purple-900 p-3"
        >
          <textarea
            required
            className="border border-purple-800 bg-purple-800 text-white rounded-lg w-full p-2 h-12 resize-none focus:border-purple-500 outline-none"
            value={question}
            ...
            {recognition && (
              <button
                ...
                className={`p-2 rounded-full transition-transform duration-300 ease-in-out ${
                  isListening ? "bg-pink-500" : "bg-purple-500"
                } hover:opacity-80`}
              >
            ...
            >
              <FaPaperPlane
                className={`text-white ${
                  generatingAnswer ? "send-animation" : ""
                }`}
              />
            </button>
          </div>
